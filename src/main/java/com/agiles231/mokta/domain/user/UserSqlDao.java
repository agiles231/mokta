...
public class UserSqlDao implements UserDao {
	...
	public User get(String id) {
		...
		User user = jdbcTemplate.query(getUserSql, new Object[] {id}, (rs) -> {
			rs.next();
			Credentials credentials = new Credentials(new CredentialsPassword(null), new CredentialsRecoveryQuestion(rs.getString("recovery_question"))
					, new CredentialsProvider(rs.getString("cred_provider_type"), rs.getString("cred_provider_name")));
